// ============================================================
// VibeLab — constants.dart (Model updated to gemini-2.0-flash)
// gemini-2.0-flash: 1500 requests/day, 15 RPM — much better
// for development and production use at $0 cost.
// ============================================================
...
class VibeLabConstants {
  ...
  // ----------------------------------------------------------
  // GEMINI API
  // gemini-2.0-flash: 1500/day free — stable and reliable
  // ----------------------------------------------------------
  ...
  static const List<Map<String, String>> vibePresets = [
    {'label': 'Rainy Tokyo', 'prompt': 'Rainy Tokyo at 2AM, neon reflections'},
    {'label': 'Hype Fest', 'prompt': 'High energy college music festival Friday night'},
    {'label': 'Lo-fi Study', 'prompt': 'Cozy lo-fi study session in a warm cafe'},
